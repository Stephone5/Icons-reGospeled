...
- `reading-finder/` — the **Reading Finder**: a 3-question tool that recommends books from the reGospeled reading path and links out to Bookshop/Amazon. Self-contained single file (fonts + book covers embedded).
...
- Reading Finder: `https://stephone5.github.io/Icons-reGospeled/reading-finder/`

A custom domain (e.g. `iconsrg.org`) can be added later in Settings → Pages.

## Updating the Reading Finder
